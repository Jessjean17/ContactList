                        ...
                        <div className="top-line">
                            ...
                            <Link to={"/editContact/" + contact.id}>
                                ...
                                <div className="contact-delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-trash3-fill" viewBox="0 0 16 16" onClick={() => actions.deleteContact(contact.id)}>
